<div class="">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl tracking-widest py-3 px-6 text-gray-600 rounded-xl border-b-2 border-gray-500 font-thin mb-6  bg-white">Distritos</h1>
                    ...
                    @foreach($distritos as $distrito)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($distrito->creadoPor != null)

                                    <span class="font-semibold">Registrado por: {{$distrito->creadoPor->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($distrito->actualizadoPor != null)

                                    <span class="font-semibold">Actualizado por: {{$distrito->actualizadoPor->name}}</span> <br>
    ...
    <x-confirmation-modal wire:model="modalBorrar">
        ...
        <x-slot name="content">
            ¿Esta seguro que desea eliminar al distrito? No sera posible recuperar la información.
        </x-slot>
