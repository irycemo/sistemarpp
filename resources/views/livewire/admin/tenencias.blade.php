<div class="">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl tracking-widest py-3 px-6 text-gray-600 rounded-xl border-b-2 border-gray-500 font-thin mb-6  bg-white">Tenencias</h1>
                    ...
                    @foreach($tenencias as $tenencia)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($tenencia->creadoPor != null)

                                    <span class="font-semibold">Registrado por: {{$tenencia->creadoPor->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($tenencia->actualizadoPor != null)

                                    <span class="font-semibold">Actualizado por: {{$tenencia->actualizadoPor->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    @can('Editar tenencia')
                                        ...
                                        <button
                                            wire:click="abrirModalEditar({{$tenencia}})"
                                    ...
                                    @can('Borrar tenencia')
                                        ...
                                        <button
                                            wire:click="abrirModalBorrar({{$tenencia}})"
                                            wire:loading.attr="disabled"
