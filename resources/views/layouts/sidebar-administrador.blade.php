<div x-data="{openRoles:true, openDistritos:true}">
    ...
    @can('Lista de distritos')
        ...
        <div class="flex items-center mb-3 w-full justify-between hover:text-red-600 transition ease-in-out duration-500 hover:bg-gray-100 rounded-xl">
            ...
            <a href="{{ route('distritos') }}" class=" capitalize font-medium text-md  flex hover w-full  p-2 px-4 ">
            ...
            <svg @click="openDistritos = false" x-show="openDistritos" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 text-gray-300 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
            </svg>

            <svg @click="openDistritos = true" x-show="!openDistritos" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 text-gray-300 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
            </svg>
    ...
    <div
        ...
        x-transition:leave-end="opacity-0 scale-90"
        x-transition:enter-start="scale-75"
        class="flex flex-col items-center mb-3 w-full justify-between  transition ease-in-out duration-500 text-sm"
        x-show="!openDistritos">

        <a href="{{ route('municipios') }}" class=" capitalize font-medium text-md  flex hover w-full   p-2 px-4 ml-5 hover:text-red-600 hover:bg-gray-100 rounded-xl ease-in-out duration-500">
        ...
        <a href="{{ route('tenencias') }}" class=" capitalize font-medium text-md  flex hover w-full   p-2 px-4 ml-5 hover:text-red-600 hover:bg-gray-100 rounded-xl ease-in-out duration-500">
        ...
        <a href="{{ route('ranchos') }}" class=" capitalize font-medium text-md  flex hover w-full   p-2 px-4 ml-5 hover:text-red-600 hover:bg-gray-100 rounded-xl ease-in-out duration-500">
